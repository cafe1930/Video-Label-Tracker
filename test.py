...
class bboxes_container:
    ...
    def register_auto_bbox(self, class_name, auto_idx, object_description=''):
        ...
        bbox = filtered_df['bbox'][index]
        bbox.manual_idx = manual_idx
        #self.bboxes_df.loc[index, 'bbox'].manual_idx = manual_idx
