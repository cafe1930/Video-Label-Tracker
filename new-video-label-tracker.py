...
class RegisterObjectsDialog(QDialog):
    def __init__(self, registered_objects_container, available_classes_list):
        ...
        registered_bboxes_list = registered_objects_container.get_registered_bboxes_list()
        registered_bboxes_list = [f'{bbox.class_name},{bbox.manual_idx}' for bbox in registered_bboxes_list]
        self.registered_bboxes_combobox.addItems(['---']+registered_bboxes_list)
        # автоматически сгенерированные рамки
        autogenerated_bboxes_list = registered_objects_container.get_autogenerated_bboxes_list()
        autogenerated_bboxes_list = [f'{bbox.class_name},(AG){bbox.manual_idx}' for bbox in autogenerated_bboxes_list]
...
'''
    ...
    def register_objects_handling(self):
        ...
        # DEBUG
        from test import bboxes_container
        container = bboxes_container()
